...
linha_minas:				; linha em que cada boneco está (inicializada com a linha inicial)
	WORD 0
	WORD 0
	WORD 0
	WORD 0
                              
coluna_minas:				; coluna em que cada boneco está (inicializada com a coluna inicial)
	WORD 5
	WORD 15
	WORD 24
	WORD 46
...
testa_mover_esquerda:
	MOV	 R3, [tecla_continuo]	; lê o LOCK e bloqueia até o teclado escrever nele novamente
	CMP	 R3, TECLA_D		; é a coluna da tecla E?
	JZ  move_esquerda
